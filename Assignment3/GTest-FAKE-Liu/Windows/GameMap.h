...
public:
	...
	void render_and_print_display_map(const Player* const players[], int num_players) const;
    
    void render_map_for_GTest(const Player* const players[], int num_players) const;
